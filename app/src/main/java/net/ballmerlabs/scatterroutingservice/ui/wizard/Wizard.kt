        ...
        Surface {
            ...
            HorizontalPager(state = pagerState) { page ->
                ...
                Row(horizontalArrangement = Arrangement.SpaceBetween, verticalAlignment = Alignment.CenterVertically,) {
                    ...
                    Icon(modifier = Modifier.size(arrowWidth, arrowHeight), painter =  painterResource(R.drawable.baseline_keyboard_double_arrow_left_24), contentDescription = "next")
                    Column(modifier = modifier.weight(1F).padding(start = 4.dp), verticalArrangement = Arrangement.SpaceBetween) {
                    ...
                    Icon(modifier = Modifier.size(arrowWidth, arrowHeight), painter =  painterResource(R.drawable.baseline_keyboard_double_arrow_right_24), contentDescription = "next")
                }
            }
        }
    } else {
